...
- **Story uploads or submissions** (if you are an author or creator)  
- **Feedback or communications** you send to us  
- **Purchase information** from in-app transactions, handled through the App Store or Google Play  

### **B. Automatically Collected Data**
- **Usage information**, such as gameplay choices, session duration, and story completions  
- **Device and log data**, including IP address, device type, operating system, app version, and crash logs  
- **Cookies or analytics data** (for website visitors only)  

We use this information to operate and improve the platform, personalize your experience, and troubleshoot issues.
...
- **Service providers** who help us operate the platform (e.g., analytics, hosting, or payment processors)  
- **App store platforms** (e.g., Apple, Google) for billing and distribution  
- **Legal authorities**, if required by law or to protect user safety  

Story data and gameplay choices are stored securely and are not shared with other users unless you explicitly choose to publish or share your content.
...
We use encryption, access controls, and secure storage methods to protect your personal data.  
However, no system is 100% secure, and we cannot guarantee absolute protection from unauthorized access.
...
Some Stories or creator pages may include links or embedded content from external sites.  
...
We ensure that data is handled in compliance with applicable privacy laws wherever it is processed.
