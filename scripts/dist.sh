...
cp ./stories/favicon.ico ./www_tmp/talewell
cp ./stories/favicon-*.png ./www_tmp/talewell

mkdir www_tmp/talewell/privacy
cp ./stories/privacy/index.html ./www_tmp/talewell/privacy/index.html


cd ./stories/basic_story
zip -r basic_story story.json thumbnail.jpg images audio
cd ../../
cp ./stories/basic_story/basic_story.zip ./www_tmp/talewell

cd ./stories/music_demo
zip -r music_demo story.json thumbnail.jpg images audio
cd ../../
cp ./stories/music_demo/music_demo.zip ./www_tmp/talewell

cd ./stories/lullaby_star
zip -r lullaby_star story.json thumbnail.jpg images audio
cd ../../
cp ./stories/lullaby_star/lullaby_star.zip ./www_tmp/talewell
cp ./stories/lullaby_star/thumbnail.jpg ./www_tmp/talewell/images/ls_thumbnail.jpg

cd ./stories/totes_vol1_ep1
zip -r totes_vol1_ep1 story.json thumbnail.jpg images audio
cd ../../
cp ./stories/totes_vol1_ep1/totes_vol1_ep1.zip ./www_tmp/talewell
